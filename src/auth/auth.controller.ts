...
export class AuthController {
  ...
  async kakaoRedirect(@Res() res: Response): Promise<void> {
    ...
    const getCodePageUrl = `https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=${process.env.KAKAO_API_KEY}&redirect_uri=${process.env.KAKAO_LOGIN_REDIRECT_URL}`;
